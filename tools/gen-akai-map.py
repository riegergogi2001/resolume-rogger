...
Writes:
  src/renderer/js/akai-map.js                (ES module: const APC = {...})
...
JS_OUT = os.path.join(REPO, 'src/renderer/js/akai-map.js')
...
def main():
    ...
    js = ('// GENERATED by tools/gen-akai-map.py — do not edit by hand.\n'
          '// APC40 mkII mapping snapshot for the read-only AKAI page.\n'
          f'export const APC = {payload};\n')
