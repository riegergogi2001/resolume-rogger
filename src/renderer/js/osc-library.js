...
export const LIBRARY = [
  ...
  { group: 'Layer', label: 'Layer master', address: '/composition/layers/{L}/master', float: true },
  { group: 'Layer', label: 'Layer video opacity', address: '/composition/layers/{L}/video/opacity', float: true },
